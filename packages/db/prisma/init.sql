...
CREATE TABLE "companies" (
    ...
    "jurisdiction" TEXT,
    "identity_jurisdiction" TEXT GENERATED ALWAYS AS (COALESCE("jurisdiction", '')) STORED,
    "website" TEXT,
    "address" TEXT,
...
CREATE UNIQUE INDEX "notification_outbox_organization_id_dedupe_key_key" ON "notification_outbox"("organization_id", "dedupe_key");
...
-- CreateIndex
CREATE UNIQUE INDEX "applicants_organization_id_email_key" ON "applicants"("organization_id", "email");
...
-- CreateIndex
CREATE UNIQUE INDEX "documents_deal_id_storage_key_key" ON "documents"("deal_id", "storage_key");
...
CREATE INDEX "notification_outbox_status_available_at_created_at_idx" ON "notification_outbox"("status", "available_at", "created_at");
CREATE INDEX "notification_outbox_organization_id_created_at_idx" ON "notification_outbox"("organization_id", "created_at");
CREATE INDEX "notification_outbox_status_locked_at_idx" ON "notification_outbox"("status", "locked_at");
...
-- CreateIndex
CREATE UNIQUE INDEX "jobs_intake_submission_id_key" ON "jobs"("intake_submission_id");
...
-- AddForeignKey
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_intake_submission_id_fkey" FOREIGN KEY ("intake_submission_id") REFERENCES "intake_submissions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
